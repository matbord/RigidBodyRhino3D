...
namespace Jitter.Dynamics.Constraints
{
    ...
    public class PointOnPoint : Constraint
    {
        ...
        public PointOnPoint(RigidBody body1, RigidBody body2, JVector anchor)
            : base(body1, body2)
        {
            JVector.Subtract(ref anchor, ref body1.position, out localAnchor1);//jmatrix di ancor-jmatrix di position
            JVector.Subtract(ref anchor, ref body2.position, out localAnchor2);

            JVector.Transform(ref localAnchor1, ref body1.invOrientation, out localAnchor1);//trasforma una matrice in un vettore
