...
namespace Jitter
{
    ...
    public class World
    {
        ...
        private JVector gravity = new JVector(0, 0, -9.81f); //The original was new JVector(0, -9.81f, 0); I change it because Z is the height and the gravity goes from up to down
        ...
        public void Step(float timestep, bool multithread)
        {
            ...
            // Calculate this: smorzamento angolare e lineare in base al tempo
            currentAngularDampFactor = (float)Math.Pow(angularDamping, timestep); //angularDamping = smorzamento angolare
